...
# 普通用法: bash <(curl -L https://raw.githubusercontent.com/librz/shell_scripts/main/show_non_printable.sh) filename.txt
# piping用法: echo "H" | bash <(curl -L https://raw.githubusercontent.com/librz/shell_scripts/main/show_non_printable)
...
yes Y | apt install bsdmainutils xxd
